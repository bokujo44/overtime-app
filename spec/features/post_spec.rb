...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    xit 'has a scope so that only post creators can see their posts' do
      other_user = User.create(first_name: 'Non', last_name: 'Authorized', email: "nonauth@example.com", password: "123456", password_confirmation: "123456", phone: "5555555555")
  ...
  describe 'new' do
    ...
    employee = Employee.create(first_name: 'Employee', last_name: 'Authorized', email: "employee@example.com", password: "123456", password_confirmation: "123456", phone: "5555555555")
